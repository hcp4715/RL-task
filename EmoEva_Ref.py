...
# -*- coding: utf-8 -*-
"""
Purpose of this script: re-write the reinforcement learning task in Bavard et al. 2018 in Psychopy.

Created on Sunday Jun. 09, 2019.
@author: Chuan-Peng Hu, PHD, Neuroimaging Center, Mainz
@email: hcp4715 at gmail dot com

This script is used for practice.
...
expName = 'EVR_p1'  # from the Builder filename that created this script
